...
{{< img src="2019-dogon-1.png" desc="起動直後の画面" >}}

上下左右の矢印キーで視点を移動、`-`でズームアウト。
`+`でズームインできるとあるが、動作しなかった（シフトを押さずに`+`を押せとあるが、それもダメだった）。
スペースでシミュレーションの開始と停止。

{{< img src="2019-dogon-2.png" desc="少し進めた画面" >}}
...
2の累乗にアラインしている同じパターンを共通化した四分木のDAG構造みたいなデータ構造でライフゲームの配置を表現することで、1世代ごとではなく2の累乗世代を1ステップで計算できる。
...
ライフゲーム自体はIOCCCで定番のネタで、先行関連作品に[[[1991/davidguy]]]({{< relref "/1991/davidguy/" >}})、[[[1993/dgibson]]]({{< relref "/1993/dgibson/" >}})、[[[2011/blakely]]]({{< relref "/2011/blakely/" >}})、[[[2012/dlowe]]]({{< relref "/2012/dlowe/" >}})がある。
...
{{< img src="2019-dogon-3.png" desc="'IOCCC 2019 #Hash Life Rules!'というメッセージが流れる（ものすごくズームアウトしている）" >}}
