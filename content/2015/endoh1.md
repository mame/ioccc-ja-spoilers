...
{{< img src="2015-endoh1-1.png" desc="ブラウザの画面（起動直後）" >}}

{{< img src="2015-endoh1-2.png" desc="ブラウザの画面（変化していく）" >}}

{{< img src="2015-endoh1-3.png" desc="ブラウザの画面（安定した様子）" >}}

マウスカーソルをブラウザの画面の上で動かすことでかき混ぜることができる。

他にもコンパイルオプションでいろいろな挙動をさせられる。

{{< img src="2015-endoh1-4.png" desc="make gray-scott-2の様子" >}}

{{< img src="2015-endoh1-5.png" desc="make oregonatorの様子" >}}

詳しくはhint.textを参照のこと。

{{< youtube src="G6Gz8qpb_Ek" desc="作者によるデモ動画" >}}
...
賞名は[[[2015/yang]]]({{< relref "/2015/yang/" >}})と対称的になっている。
