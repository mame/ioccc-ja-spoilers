...
hint_url: "https://www.ioccc.org/2005/persano/index.html"
...
{{< img src="2005-persano-1.gif" desc="(5,2)型のトーラス結び目" >}}
...
{{< img src="2005-persano-3.gif" desc="(3,16)型のトーラス結び目（粗すぎて生成失敗）" >}}

`#define H 100`とした結果がこちら。

{{< img src="2005-persano-4.gif" desc="(3,16)型のトーラス結び目（きちんと生成できた）" >}}

問2の答え：`sr = 15`を`sr = 5`などとすれば細くなる。`./persano 5 2`の例。

{{< img src="2005-persano-2.gif" desc="(5,2)型のトーラス結び目（細め）" >}}
