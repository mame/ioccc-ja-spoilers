...
ソースコード自体がマップになっていて、デフォルトではソースコード自身が使われる。

ソースコードが迷路データとなっているネタは[[[1991/buzzard]]]({{< relref "/1991/buzzard/" >}})、cursesでの迷路というネタは[[[1995/dodsond2]]]({{< relref "/1995/dodsond2/" >}})とかぶっている。
