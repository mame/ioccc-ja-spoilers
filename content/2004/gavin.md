...
{{< img src="2004-gavin.png" desc="QEMU内で動作するOSの画面" >}}
...
興味がある人のために、動作が確認できた[kernel]({{< static-url "imgs/2004-gavin-kernel" >}})と[fs.tar]({{< static-url "imgs/2004-gavin-fs.tar" >}})を置いておく。
