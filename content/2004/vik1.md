...
{{< img src="2004-vik1-1.png" desc="デフォルトのゲーム画面" >}}
...
{{< img src="2004-vik1-2.png" desc="冬モード" >}}
...
{{< img src="2004-vik1-3.png" desc="夏の夜モード" >}}
...
{{< img src="2004-vik1-4.png" desc="冬の夜モード" >}}

トラックの選択もでき、`2`とすると夏の昼のトラック2、`ad3`とすると冬の夜のトラック3など。

作者自身によるYouTube動画。

{{< youtube src="xTseqWCtAUA" desc="作者によるデモ動画" >}}
