...
{{< audio src="2011-vik-1.mp3" desc="randowan.wav" cite="http://www.ioccc.org/2011/vik/randowan.mod" >}}

```
$ ./vik mad_world.mod > mad_world.raw && ./raw2wav mad_world.raw > mad_world.wav
```

{{< audio src="2011-vik-2.mp3" desc="mad_world.wav" cite="http://www.ioccc.org/2011/vik/mad_world.mod" >}}

作者自身によるYouTube動画。

{{< youtube src="ZvYcjxsMNoM" desc="作者によるデモ動画" >}}
