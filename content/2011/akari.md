...
{{< img src="2011-akari-1.png" desc="IOCCCと書かれた画像（example.ppm）" cite="https://www.ioccc.org/2011/akari/example.ppm" >}}
...
{{< img src="2011-akari-2.png" desc="奇数番目のピクセルだけを取り出した画像（odd_output.png）" >}}
...
{{< img src="2011-akari-3.png" desc="偶数番目のピクセルだけを取り出した画像（even_output.png）" >}}
...
IOCCCと言えばこれを思い浮かべる人も多いのではないだろうか。
...
作者は[[[2000/dhyang]]]({{< relref "/2000/dhyang/" >}})や[[[2004/omoikane]]]({{< relref "/2004/omoikane/" >}})と同じDon Yang。
