...
order: 2
authors: "Don_Dodson"
orig_url: "https://www.ioccc.org/1994/dodsond2/dodsond2.orig.c"
hint_url: "https://www.ioccc.org/1994/dodsond2/index.html"
...
目的は、ウンパス（Wumpus）というモンスターを倒すこと。
矢を拾って、モンスターの位置を予測して、隣の部屋から矢を射って当たればクリア。
ウンパスが近くにいると「匂いがする」という表示が出る（同じ部屋に入ってしまうと食われる）。
