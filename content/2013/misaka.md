...
他の難読化としては、ランレングス圧縮したlongcat、対称的な変数名（`p`、`q`、`b`、`d`など）、ソースコードのCRCをソースコードに埋め込んでいる（[[[2004/omoikane]]]({{< relref "/2004/omoikane/" >}})参照）など。
[[[2012/omoikane]]]({{< relref "/2012/omoikane/" >}})と同様にspoiler.htmlが添付されている。
