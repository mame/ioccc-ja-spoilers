...
{{< img src="2013-hou-1.png" desc="最初に書き出された画像" >}}

画像を書き出してもレンダリングは走り続け、定期的にファイルを上書きしていく。
画像は徐々に高画質になっていく。
一晩くらい走らせ続けると、このくらいの品質になるとのこと。

{{< img src="2013-hou-2.jpg" desc="一晩程度走らせた結果" cite="https://www.ioccc.org/2013/hou/luna.jpg" >}}
...
[[[2004/gavare]]]({{< relref "/2004/gavare/" >}})から始まったレイトレーシング系作品の終着点だろうか。
