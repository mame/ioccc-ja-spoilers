...
それぞれ、行数、ワード数、文字数、IOCCCのサイズルールに従ったサイズ、ルールとキーワードのためにカウントが減った文字数、キーワードの数、キーワードの文字数を1とカウントした場合にカウントが減った文字数。
...
iocccsizeのバグを悪用した[[[2014/birken]]]({{< relref "/2014/birken/" >}})を正しく測定できる。
