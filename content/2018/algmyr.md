...
{{< audio src="2018-algmyr-1.mp3" desc="hello.wav" >}}

しかし、周波数のスペクトログラムを表示すると、意味がわかる。

```
$ sox hello.wav -n spectrogram -d 10 -X 300
```

{{< img src="2018-algmyr-2.png" desc="spectrogram.png" >}}

つまり、スペクトログラムにしたときにメッセージが表示されるような音声を合成している。
...
{{< img src="2018-algmyr-3.png" desc="ステレオ版spectrogram.png" >}}

## 解説

音声の周波数のスペクトログラムを表示したら文字が出てくるような音声データを生成するプログラム。
...
このプログラムの苦労した点として、音を突然再生し始めるとスペクトル漏れによってスペクトログラムが読みにくくなってしまう問題があったらしい。
窓関数を導入して緩和したとのこと。
