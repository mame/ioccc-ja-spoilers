...
{{< img src="2006-stewart-1.png" desc="gasket.xbm（シェルピンスキーのギャスケット）" >}}
...
{{< img src="2006-stewart-2.png" desc="dragon.xbm（ドラゴン曲線）" >}}
...
{{< img src="2006-stewart-3.png" desc="fern.xbm（シダ画像）" >}}
...
{{< img src="2006-stewart-4.png" desc="tree2.xbm（木）" >}}
...
{{< img src="2006-stewart-5.png" desc="ioccc.xbm（IOCCCのロゴになりたかったもの）" >}}
...
[[[1992/imc]]]({{< relref "/1992/imc/" >}})や[[[1994/tvr]]]({{< relref "/1994/tvr/" >}})など、フラクタルを生成する作品はいくつも実績があるけれど、反復関数系（IFS）を扱うものは初とのこと。
...
賞名は[[[2006/monge]]]({{< relref "/2006/monge/" >}})と対称的になっている。
